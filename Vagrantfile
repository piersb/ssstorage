...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider "parallels" do |parallel|
    parallel.update_guest_tools = true
    parallel.customize ["set", :id, "--smart-mount", "off"]
    #parallel.customize ["guestproperty", "set", :id, "--timesync-threshold", 5000]
  end
